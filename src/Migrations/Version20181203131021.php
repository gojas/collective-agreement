 ...
 */
final class Version20181203131021 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE core_users ADD created_by_id INT DEFAULT NULL, ADD modified_by_id INT DEFAULT NULL, ADD deleted_by_id INT DEFAULT NULL, ADD unique_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid_binary)\', ADD created_at DATETIME DEFAULT NULL, ADD modified_at DATETIME DEFAULT NULL, DROP firstname, DROP lastname, DROP email, DROP email_canonical, DROP username, DROP username_canonical, CHANGE id id INT NOT NULL');
