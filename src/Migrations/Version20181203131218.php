 ...
 */
final class Version20181203131218 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE superadmin_bonuses (id INT UNSIGNED NOT NULL, created_by_id INT UNSIGNED DEFAULT NULL, modified_by_id INT UNSIGNED DEFAULT NULL, deleted_by_id INT UNSIGNED DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, unique_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid_binary)\', created_at DATETIME DEFAULT NULL, modified_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_3F4C90D8E3C68343 (unique_id), INDEX IDX_3F4C90D8B03A8386 (created_by_id), INDEX IDX_3F4C90D899049ECE (modified_by_id), INDEX IDX_3F4C90D8C76F1F52 (deleted_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE superadmin_holiday_calendars (id INT UNSIGNED NOT NULL, created_by_id INT UNSIGNED DEFAULT NULL, modified_by_id INT UNSIGNED DEFAULT NULL, deleted_by_id INT UNSIGNED DEFAULT NULL, unique_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid_binary)\', created_at DATETIME DEFAULT NULL, modified_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_9139AC78E3C68343 (unique_id), INDEX IDX_9139AC78B03A8386 (created_by_id), INDEX IDX_9139AC7899049ECE (modified_by_id), INDEX IDX_9139AC78C76F1F52 (deleted_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE core_users ADD created_by_id INT UNSIGNED DEFAULT NULL, ADD modified_by_id INT UNSIGNED DEFAULT NULL, ADD deleted_by_id INT UNSIGNED DEFAULT NULL, ADD unique_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid_binary)\', ADD created_at DATETIME DEFAULT NULL, ADD modified_at DATETIME DEFAULT NULL, DROP firstname, DROP lastname, DROP email, DROP email_canonical, DROP username, DROP username_canonical, CHANGE id id INT UNSIGNED NOT NULL');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_42028409E3C68343 ON core_users (unique_id)');
        $this->addSql('CREATE INDEX IDX_42028409B03A8386 ON core_users (created_by_id)');
        $this->addSql('CREATE INDEX IDX_4202840999049ECE ON core_users (modified_by_id)');
        $this->addSql('CREATE INDEX IDX_42028409C76F1F52 ON core_users (deleted_by_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_42028409E3C68343 ON core_users');
        $this->addSql('DROP INDEX IDX_42028409B03A8386 ON core_users');
        $this->addSql('DROP INDEX IDX_4202840999049ECE ON core_users');
        $this->addSql('DROP INDEX IDX_42028409C76F1F52 ON core_users');
        $this->addSql('ALTER TABLE core_users ADD firstname VARCHAR(255) NOT NULL COLLATE latin1_swedish_ci, ADD lastname VARCHAR(255) NOT NULL COLLATE latin1_swedish_ci, ADD email VARCHAR(255) DEFAULT NULL COLLATE latin1_swedish_ci, ADD email_canonical VARCHAR(255) DEFAULT NULL COLLATE latin1_swedish_ci, ADD username VARCHAR(255) DEFAULT NULL COLLATE latin1_swedish_ci, ADD username_canonical VARCHAR(255) DEFAULT NULL COLLATE latin1_swedish_ci, DROP created_by_id, DROP modified_by_id, DROP deleted_by_id, DROP unique_id, DROP created_at, DROP modified_at, CHANGE id id INT UNSIGNED AUTO_INCREMENT NOT NULL');
    }
}
